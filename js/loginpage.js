...
const loginPage = {
    init() {
        ...
        this.getRegisterContainer = () => {
            return registerContainer;
        }
        registerContainer.style.display = "none"; //이걸 어떻게 하지?
    ...
    makeLoginPage() {
        ...
        document.body.insertAdjacentElement("afterbegin", loginContainer);
    ...
    makeRegisterButton(container, type) {
        ...
        button.addEventListener("click", () => {
            // page = "register";
            this.getloginContainer().style.display = "none";
            this.getRegisterContainer().style.display = "flex";
        });
        align1.className = "col-md-3 col-xs-3 col-sm-3";
        align2.className = "col-md-7 col-xs-7 col-sm-7 loginform-container";
        align2.appendChild(button);
